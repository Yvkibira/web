...
head.appendChild(scriptElement);
 ...
 function scriptAdd(){var excludedpages = ['disclaimer','fashion','farming','opinions','privacy-policy','websites','services','health','wellness','life','safety','travel','jobs','politics','education','book-review'];var shouldAppendScript = true;for (var i = 0; i < excludedpages.length; i++) {var check = 'https://www.pioneerblogspot.co.ke/' + excludedpages[i]+'.html';if(window.location.pathname === check || window.location.pathname ==="https://www.pioneerblogspot.co.ke/") {shouldAppendScript = false;break;}}if (shouldAppendScript) {var script = document.createElement('script');script.type = 'text/javascript';script.src = 'banner.js';document.head.appendChild(script);}}window.addEventListener("load",scriptAdd);
