window.onload = function() {const toggleButton = document.getElementById('toggle-button');const toggleElements = document.querySelectorAll('.toggle-element');toggleButton.addEventListener('click', function() {toggleElements.forEach(element => {element.classList.toggle('hidden');});});
...
`;var firstChild=mainElement.firstChild;mainElement.insertBefore(adSection, firstChild);}}setTimeout(scriptAdd),1000;};
